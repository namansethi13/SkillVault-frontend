...
<div class=" flex flex-col bg-red-500 w-full h-full">
    ...
    <div class="flex flex-col  bg-[#F3E4CF] h-full overflow-auto items-stretch ">
        ...
        <h3 class="text-red-600 font-extrabold md:text-3xl text-xl font-sans">{event.name}</h3>
        </div>
    ...
    <div class="flex space-x-0.5">
        ...
        <a href="https://meet.google.com/{event.link}"><p class="text-black underline font-semibold text-sm md:text-lg"> https://meet.google.com/{event.link}</p></a>
        </div>
